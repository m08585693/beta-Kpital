...
import { ArrowLeft, Plus, Trash2, Clock, TrendingUp } from 'lucide-react';
      ...
      <div className="max-w-2xl mx-auto">
        ...
        <div className="bg-[#0d1117] border border-[#1c2230] rounded-2xl p-5 mb-4">
          <div className="flex items-center justify-between mb-1">
            ...
            <span className={`text-xs font-medium ${pct >= 100 ? 'text-emerald-400' : 'text-[#4d9eff]'}`}>
              {pct.toFixed(1)}%
            </span>
          </div>
            ...
            <div className="space-y-2">
              {payments.map((payment) => {
                ...
                return (
                  <div
                    key={payment.id}
                    className="flex items-center justify-between bg-[#0d1117] border border-[#1c2230] rounded-xl px-4 py-3"
                  >
